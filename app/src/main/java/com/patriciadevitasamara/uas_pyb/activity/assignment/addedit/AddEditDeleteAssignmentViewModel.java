...
public class AddEditDeleteAssignmentViewModel extends ViewModel {
    ...
    public void addAssigment(Context context, String judul, String materi, String deskripsi){
        String header = HeaderHelper.generateHeader(context);
        apiService.createAssignment(header, judul, materi, deskripsi).enqueue(new Callback<>() {
            @Override
            public void onResponse(@NotNull Call<AssignmentAddResponse> call, @NotNull Response<AssignmentAddResponse> response) {
                if (response.isSuccessful()) {
                    ...
                    if (response.body() != null) {
                        Log.e(Constant.COURSE_TAG, "onFailure: create assignment gagal");
                    }
                }
            }
    ...
    public void editAssigment(Context context, String judul, String materi, String deskripsi, int id){
        String header = HeaderHelper.generateHeader(context);
        apiService.updateAssignment(header, id, judul, materi, deskripsi).enqueue(new Callback<>() {
            @Override
            public void onResponse(@NotNull Call<AssignmentAddResponse> call, @NotNull Response<AssignmentAddResponse> response) {
                if (response.isSuccessful()) {
                    if (response.body() != null) {
                    ...
                    _assignmentError.setValue(true);
                    if (response.body() != null) {
                        Log.e(Constant.COURSE_TAG, "onFailure: update assignment gagal");
                    }
                }
            }
    ...
    public void deleteAssigment(Context context, int id){
        String header = HeaderHelper.generateHeader(context);
        apiService.deleteAssignment(header, id).enqueue(new Callback<>() {
            @Override
            public void onResponse(@NotNull Call<AssignmentAddResponse> call, @NotNull Response<AssignmentAddResponse> response) {
                if (response.isSuccessful()) {
                    if (response.body() != null) {
                    ...
                    _assignmentError.setValue(true);
                    if (response.body() != null) {
                        Log.e(Constant.COURSE_TAG, "onFailure: delete assignment gagal");
                    }
                }
            }
